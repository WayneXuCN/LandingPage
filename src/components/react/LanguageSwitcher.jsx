...
const LanguageSwitcher = ({ currentLang = 'en_US' }) => {
  ...
  return (
    <button
      ...
      className='relative link-underline ml-2 px-0.5 py-1 font-display italic text-sm tracking-[0.15em] text-inksoft hover:text-ink transition-colors focus:outline-none'
