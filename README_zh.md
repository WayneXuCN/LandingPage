...
1. **域名配置**：
   - **有域名的情况**：设置 `site` 为您的完整域名（如
     `https://your-domain.com`）
   - **本地测试无域名**：将 `site` 设置为空字符串或注释掉此行，系统会自动使用
     `http://localhost:4321`（开发环境）或相对路径（生产环境）
...
- 使用 `ISO 639-1` 语言代码 + `ISO 3166-1 alpha-2` 国家代码格式（如
  `en_US`、`zh_CN`）
...
<p align="center">
  Made with love by <a href="https://github.com/Vncntvx">Wenjie Xu</a>
</p>
